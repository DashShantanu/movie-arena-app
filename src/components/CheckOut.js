...
const CheckOut = () => {
    ...
    const onSubmit = async (res) => {
        ...
        await axios.post(`https://61dbe2ea591c3a0017e1a59e.mockapi.io/Ticket`, {
            ...
            , info: {
                Name: details[1].Name, Email: details[1].Email,
        ...
        <div style={{ backgroundColor: 'white', height: '90vh' }}>
            <Container sx={{ margin: "20px" }}>
                ...
                <Grid container spacing={2}>
                    ...
                    <Grid item xs={4}>
                        <Typography variant="h5" sx={{ margin: "20px", color: 'black' }} component="h5">
                            {data.data.title}
                        </Typography>
                            ...
                            <CardContent>
                                <form onSubmit={handleSubmit(onSubmit)}>
                                    ...
                                    <Button onClick={() => {
                                        handleOpen()
                                        getPassword()
                                    }} disabled={FinalConfirm ? true : false} color={FinalConfirm ? 'success' : 'primary'} type='submit' variant="contained">
                    ...
                    <Grid item xs={4}>
                        ...
                        <Container>
                            ...
                            <Card sx={{ maxWidth: '350px', alignItems: "center", justifyContent: "center" }}>
                                <CardContent>
                                    <Typography>
                                        {code.length !== 0 ? ` Download this QR with Ticket code ` : ` QR will be generated here...`}
                                    </Typography>
                ...
                >
                    <Box sx={{
                        ...
                        <Stack spacing={2} direction="row">
                            <Button variant="contained" disabled={openAlert} onClick={() => {
                                handleClose()
                                setFinalConfirm(true); setOpenAlert(true)
